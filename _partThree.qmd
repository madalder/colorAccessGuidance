### Part 3: Color and Digital Accessibility {#sec-partThree .part}
...
-   The **Silver** and **Gold** levels are more complex.
    ...
    -   You can check the requirements for specific font size and weight combinations using the applicable [APCA Font Lookup Tables](https://readtech.org/ARC/tests/visual-readability-contrast/?tn=criterion#tables).
