### Part 2: The Diversity of Human Color Perception {.part #sec-partTwo}
...
Check out [**Colours in Cultures**](https://informationisbeautiful.net/visualizations/colours-in-cultures/), an infographic that visualizes color meanings across cultures
...
::: {.callout-warning title="A Note on 'Color Psychology'"}
